...
| R-05 | Intake UI treats restricted/master/numeric fields as arbitrary text because the current DTO shape is string-based | H | H | Child web planning must apply UI Design/Data Semantics and child api planning must create/residualize catalog or stronger-domain support when required | web/ + api/ owners | Open |
