# 🔍 DEEPENING: Story 01 — Teacher Login
...
|---|------|----------|--------|--------|
| 1 | [FirebaseTokenFilter en api/](story-01-teacher-login/task-01-firebase-token-filter.md) | GENERATE-DOCUMENT | DONE | `FirebaseTokenFilter.java`, `AuthenticatedTeacher` record |
| 2 | [Página de login en web/](story-01-teacher-login/task-02-sign-in-page.md) | GENERATE-DOCUMENT | DONE | `web/src/app/login/page.tsx` |
| 3 | [AuthGuard (ruta protegida)](story-01-teacher-login/task-03-protected-route-wrapper.md) | GENERATE-DOCUMENT | DONE | `web/src/components/auth/AuthGuard.tsx` |
...
- Cross-teacher denial behavior is specified in detail by story-07.

## Dependencies

| Depends on | Reason |
|------------|--------|
| story-06 or story-08 | An account must exist before sign-in is possible |
