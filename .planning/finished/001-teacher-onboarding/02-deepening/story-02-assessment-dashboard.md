# 🔍 DEEPENING: Story 02 — Assessment Dashboard
...
|---|------|----------|--------|--------|
| 1 | [GET /assessments endpoint](story-02-assessment-dashboard/task-01-assessments-list-endpoint.md) | GENERATE-DOCUMENT | DONE | `AssessmentController`, `AssessmentSummaryDto` |
| 2 | [Dashboard page en web/](story-02-assessment-dashboard/task-02-dashboard-page.md) | GENERATE-DOCUMENT | DONE | `web/src/app/(protected)/dashboard/page.tsx`, `AssessmentCard` |
...
- Empty-state UX is owned by story-05; this story only guarantees error-free rendering with zero data.
...
| Depends on | Reason |
|------------|--------|
| story-01 (teacher-login) | Dashboard is behind authentication and scoped per teacher |
