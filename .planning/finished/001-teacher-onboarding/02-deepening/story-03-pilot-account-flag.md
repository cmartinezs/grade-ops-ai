# 🔍 DEEPENING: Story 03 — Pilot Account Flag
...
|---|------|----------|--------|--------|
| 1 | [Flyway migration: columnas de flag piloto](story-03-pilot-account-flag/task-01-flyway-pilot-flag-columns.md) | GENERATE-DOCUMENT | DONE | `V2__add_pilot_flag_columns.sql` |
| 2 | [PATCH /internal/teachers/{uid}/flags](story-03-pilot-account-flag/task-02-pilot-flag-endpoint.md) | GENERATE-DOCUMENT | DONE | `InternalTeacherController` (patch), `PilotFlagService` |
...
- Applies to both self-registered (story-08) and provisioned (story-06) accounts.
...
| Depends on | Reason |
|------------|--------|
| story-06 or story-08 | A teacher account must exist before it can be flagged |
