# 🔍 DEEPENING: Story 04 — Sign-Out and Session Expiry
...
|---|------|----------|--------|--------|
| 1 | [SignOutButton + POST /auth/sign-out](story-04-sign-out-session-expiry/task-01-sign-out-action.md) | GENERATE-DOCUMENT | DONE | `SignOutButton.tsx`, endpoint `POST /auth/sign-out` |
| 2 | [API client con interceptor 401](story-04-sign-out-session-expiry/task-02-auth-error-interceptor.md) | GENERATE-DOCUMENT | DONE | `web/src/lib/api/client.ts` |
...
| Depends on | Reason |
|------------|--------|
| story-01 (teacher-login) | Sign-out and expiry act on the session created at sign-in |
