...
> **Depends On:** —
> [← story file](../story-04-sign-out-session-expiry.md)
...
- **Affected files / components:**
  ...
  - `web/src/app/login/page.tsx` (update — read `?reason=expired` to show banner; story-01 task-02 created this page)
