# 🔍 DEEPENING: Story 05 — Dashboard Empty State
...
|---|------|----------|--------|--------|
| 1 | [EmptyDashboard component](story-05-dashboard-empty-state/task-01-empty-dashboard-component.md) | GENERATE-DOCUMENT | DONE | `web/src/components/dashboard/EmptyDashboard.tsx` |
...
- Reuses the dashboard endpoint from story-02 unchanged — no API work in this story.
...
| Depends on | Reason |
|------------|--------|
| story-02 (assessment-dashboard) | Empty state is a state of the dashboard view |
