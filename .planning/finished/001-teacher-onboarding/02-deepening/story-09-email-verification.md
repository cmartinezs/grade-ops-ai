# 🔍 DEEPENING: Story 09 — Email Verification
...
|---|------|----------|--------|--------|
| 1 | [EmailVerifiedFilter en api/](story-09-email-verification/task-01-email-verified-filter.md) | GENERATE-DOCUMENT | DONE | `EmailVerifiedFilter.java`, whitelist `/auth/register`, `/auth/verify/resend` |
| 2 | [Pantalla verify-email + reenvío](story-09-email-verification/task-02-verification-screen-and-resend.md) | GENERATE-DOCUMENT | DONE | `web/src/app/verify-email/page.tsx` |
...
- Operator-provisioned accounts (story-06) also pass through verification unless created pre-verified via the Admin SDK.

## Dependencies

| Depends on | Reason |
|------------|--------|
| story-08 (teacher-self-registration) | Verification is triggered by the registration flow |
| story-11 (firebase-auth-adr) | The ADR settles whether provisioned accounts skip the verification gate |
