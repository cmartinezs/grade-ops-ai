...
> **Depends On:** task-01
> [← story file](../story-09-email-verification.md)
...
2. Add redirect to `/verify-email` in `SignInPage` (story-01 task-02): after sign-in, if `user.emailVerified === false`, redirect here instead of dashboard.
