# 🔍 DEEPENING: Story 02 — requirements-blueprint
...
Fuente: `docs/02-product/mvp-story.md` y `docs/02-product/workflows.md`
...
| # | Task | Status | Output |
|---|------|--------|--------|
| 1 | Leer `docs/02-product/mvp-story.md` y `docs/02-product/workflows.md` para confirmar el contexto de cada grupo | PENDING | Datos inline en el story |
| 2 | Leer `docs/02-product/assessment-modes.md` para extraer la tabla comparativa | PENDING | Datos inline en el story |
