# 🔍 DEEPENING: Story 04 — xprize-launch-pad
...
| # | Task | Status | Output |
|---|------|--------|--------|
| 1 | Leer `docs/00-project/hackathon-strategy.md` para extraer la tabla de criterios y evidencia GradeOps | PENDING | Datos inline en el story |
| 2 | Leer `docs/05-evidence/` (README + archivos) para mapear tipos de evidencia a entidades | PENDING | Datos inline en el story |
