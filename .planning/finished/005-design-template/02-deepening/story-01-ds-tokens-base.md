# 🔍 DEEPENING: Story 01 — ds-tokens-base
...
|---|------|----------|--------|--------|
| 1 | [Copiar tokens CSS del DS al proyecto](story-01-ds-tokens-base/task-01-copy-ds-tokens.md) | GENERATE-DOCUMENT | DONE | `web/src/styles/ds-tokens/*.css` + `globals.css` actualizado |
| 2 | [Configurar fuentes Google vía next/font en root layout](story-01-ds-tokens-base/task-02-configure-fonts.md) | GENERATE-DOCUMENT | DONE | `web/src/app/layout.tsx` actualizado |
| 3 | [Copiar logos SVG y actualizar AppLogo](story-01-ds-tokens-base/task-03-assets-applogo.md) | GENERATE-DOCUMENT | DONE | `web/public/brand/*.svg` + `AppLogo.tsx` actualizado |
...
- [ ] TRACEABILITY.md actualizado con términos de este story
