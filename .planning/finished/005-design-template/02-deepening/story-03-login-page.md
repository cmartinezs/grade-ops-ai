# 🔍 DEEPENING: Story 03 — login-page

> **Status:** DONE
> **Depends on:** story-01-ds-tokens-base
...
|---|------|----------|--------|--------|
| 1 | [Primitivos DS de formulario: Input y Field](story-03-login-page/task-01-input-field.md) | GENERATE-DOCUMENT | DONE | `web/src/components/ds/Input.tsx`, `Field.tsx` |
| 2 | [Componente GoogleButton DS](story-03-login-page/task-02-google-button.md) | GENERATE-DOCUMENT | DONE | `web/src/components/ds/GoogleButton.tsx` |
| 3 | [Redisenio de login/page.tsx con layout DS](story-03-login-page/task-03-login-page-redesign.md) | GENERATE-DOCUMENT | DONE | `web/src/app/login/page.tsx` refactorizado |
...
| 2 | `AppLogo.tsx` actual tiene gradiente indigo/blue — el DS usa Sprout verde para el logo-mark | `brand/AppLogo.tsx` vs `design/design-system/assets/logo-mark.svg` | RESOLVED | Reemplazar en story-01 con logo-mark del DS |
...
| 2 | Link "Crear cuenta" — ruta `/register` no está en el story de este planning | Planning futuro | PENDING |
