# 🔍 DEEPENING: Story 04 — dashboard-page

> **Status:** DONE
> **Depends on:** story-02-shell-layout
...
|---|------|----------|--------|--------|
| 1 | [Componentes DS del dashboard: Badge, StatCard, Card](story-04-dashboard-page/task-01-dashboard-ds-components.md) | GENERATE-DOCUMENT | DONE | `web/src/components/ds/Badge.tsx`, `StatCard.tsx`, `Card.tsx` |
| 2 | [AssessmentRow y DashboardEmptyState DS](story-04-dashboard-page/task-02-assessment-row-empty-state.md) | GENERATE-DOCUMENT | DONE | `web/src/components/dashboard/AssessmentRow.tsx`, `DashboardEmptyState.tsx` |
| 3 | [Refactor de DashboardPage con shell context y componentes DS](story-04-dashboard-page/task-03-dashboard-page-refactor.md) | GENERATE-DOCUMENT | DONE | `web/src/app/(protected)/dashboard/page.tsx` refactorizado |
