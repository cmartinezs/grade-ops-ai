...
| 4 | Status real es "GRADING" y "CLOSED" (no "IN_REVIEW"/"GRADED") — mapeo ajustado | `web/src/types/assessment.ts` vs story design | RESOLVED | GRADING→"En revisión", CLOSED→"Cerrada" |
