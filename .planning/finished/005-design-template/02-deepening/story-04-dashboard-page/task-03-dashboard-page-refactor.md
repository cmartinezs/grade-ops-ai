...
> **Depends On:** task-01, task-02, story-02/task-03 (ShellContext)
> [← story file](../story-04-dashboard-page.md)
...
- **Interfaces / contracts:** Sin cambios en el API — `getAssessments()` sigue siendo la única fuente de datos. `useShellConfig` viene de `ShellContext` (story-02/task-03).
...
- **Design notes:**
  ...
  - **Loading spinner DS:**
    ...
    ```
    > El keyframe `spin` fue agregado en globals.css en story-02/task-02.
...
- [x] No story creep: la tarea satisface `[CHECK-ATOMICITY]`
