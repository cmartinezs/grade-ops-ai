# 🔍 DEEPENING: Story 05 — placeholder-routes
...
**Shell:** implementado en story-02
...
|---|------|----------|--------|--------|
| 1 | [Rutas maqueta y PlaceholderPage](story-05-placeholder-routes/task-01-placeholder-routes.md) | GENERATE-DOCUMENT | DONE | `PlaceholderPage.tsx` + 4 rutas `page.tsx` + `app/page.tsx` actualizado |
...
├── layout.tsx                  ← Shell (story-02)
├── dashboard/
│   └── page.tsx               ← REAL (story-04)
├── assessments/
│   └── page.tsx               ← MAQUETA (story-05)
├── bank/
│   └── page.tsx               ← MAQUETA (story-05)
├── students/
│   └── page.tsx               ← MAQUETA (story-05)
