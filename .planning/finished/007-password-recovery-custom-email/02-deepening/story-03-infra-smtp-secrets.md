# 🔍 DEEPENING: Story 03 — infra-smtp-secrets

> **Status:** DONE
> **Depends on:** — (puede ejecutarse en paralelo con story-01)
...
|---|------|----------|--------|--------|
| 1 | [Secretos SMTP en Secret Manager](story-03-infra-smtp-secrets/task-01-smtp-secrets.md) | GENERATE-DOCUMENT | DONE | `smtp.tf` con 5 recursos `google_secret_manager_secret` (sin versiones — se añaden manualmente) |
| 2 | [Referencias de secretos en Cloud Run api/](story-03-infra-smtp-secrets/task-02-cloudrun-env.md) | GENERATE-DOCUMENT | DONE | `cloud_run.tf` actualizado: 5 `secretKeyRef` + env var directa `GRADEOPS_WEB_BASE_URL` |
