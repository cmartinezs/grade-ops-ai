...
| 4 | [Unit tests: Groq adapter and provider selection](story-01-groq-provider-adapter/task-04-unit-tests.md) | GENERATE-DOCUMENT | IN PROGRESS | `GroqAssessmentGenerationAdapterTest.java`, `AssessmentGenerationPortSelectorTest.java`, updated `AssessmentAgentOrchestratorTest`/`AssessmentCommandTest` |
