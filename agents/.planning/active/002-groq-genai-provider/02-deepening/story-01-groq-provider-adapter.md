...
| 2 | [Project-specific env var names + `.env` loading](story-01-groq-provider-adapter/task-02-env-config.md) | GENERATE-DOCUMENT | IN PROGRESS | `application-beta.yml`/`application-demo.yml` changes, `.env.example`, chosen dotenv-loading mechanism |
