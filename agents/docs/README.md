...
Documentation for the `grade-ops-ai-agents` service: architecture decisions and feature-scoped guidance specific to this Spring AI / Spring Boot workspace. See the root [`docs/`](../../docs/README.md) for product/architecture authority that spans the whole platform, and [`docs/03-ai-agents/`](../../docs/03-ai-agents/README.md) for the cross-cutting agent runtime, roles, and boundaries — this folder holds `agents/`-local material only.
...
[← agents/](../README.md) · [↑ Volver al inicio](#top)
