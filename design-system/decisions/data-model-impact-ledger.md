...
| DMI-009 | Plantillas reutilizables | Crear desde arquetipos de sistema o docente, personalizar, clonar y conservar origen sin mutaciones retroactivas | `AssessmentTemplate`; versiones inmutables; ownership; scope; visibility; snapshots; deprecation; migración y compatibilidad | Confirmed | MVP | In analysis | [Fundamentos del dominio evaluativo](2026-07-27-assessment-domain-foundations.md); diseño técnico pendiente |
