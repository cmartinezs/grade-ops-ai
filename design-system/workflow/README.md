...
| Archivo | Finalidad |
|---|---|
| [`01-principios-y-gobierno.md`](01-principios-y-gobierno.md) | Principios, roles, decisiones y trazabilidad |
| [`02-descubrimiento-ux.md`](02-descubrimiento-ux.md) | Investigación, usuarios, tareas y requisitos UX |
| [`03-arquitectura-informacion-flujos.md`](03-arquitectura-informacion-flujos.md) | Navegación, flujos y estados |
| [`04-exploracion-visual-stitch.md`](04-exploracion-visual-stitch.md) | Generación y selección de direcciones visuales |
| [`05-prototipado-design-system-figma.md`](05-prototipado-design-system-figma.md) | Prototipo, tokens, componentes y variantes |
| [`06-validacion-con-usuarios.md`](06-validacion-con-usuarios.md) | Pruebas de usabilidad y criterios de aceptación |
| [`07-implementacion-v0.md`](07-implementacion-v0.md) | Traducción controlada del diseño a React/Next.js |
| [`08-integracion-produccion.md`](08-integracion-produccion.md) | Adaptación al repositorio y controles técnicos |
| [`09-quality-gates.md`](09-quality-gates.md) | Criterios obligatorios para avanzar y liberar |
| [`10-prompts-operativos.md`](10-prompts-operativos.md) | Prompts base para cada herramienta |
...
[← Design System](../README.md) · [Siguiente: Principios y gobierno →](01-principios-y-gobierno.md) · [↑ Volver al inicio](#top)
