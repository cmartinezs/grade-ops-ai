...
- **17 historias (27%)** completamente enriquecidas o materializadas (Story + AC + DoD + Technical Notes + Dependencies + Complejidad): Epic 01 (12), Epic 02 (3), US-080 y US-081.
- **45 historias (73%)** esqueléticas (solo Story + Acceptance Criteria): Epics 03 a 13, excluyendo US-080/US-081 ya materializadas para R01.
...
- **Implementación real verificada** (código + planning cerrada o activa): 15/62 historias — las 12 de Epic 01 (9 completamente, más US-014 y US-015 con matices) y 2-3 de Epic 02 (US-010, US-011 implementadas; US-012 en progreso). US-080/US-081 ya estan listas a nivel documental, pero siguen pendientes de implementacion. El resto (45 historias, 73%) es backlog sin ejecución iniciada.
...
| US-080 | Agent Execution Log | 09 | P0 | Operator | Loguear cada ejecución de agente | READY | Epic 01; consumida por Epics 02-08/11-13 | Runs fallidos no se descartan silenciosamente | Materializada para R01 con DoD, notas tecnicas, dependencias y complejidad; entidad central del sistema de evidencia | Atomizar por owner; considerar tratarla como backbone compartido (ver `capability-map.md`) |
| US-081 | Cost Estimate Per Run | 09 | P0 | Operator | Estimar costo/tokens por ejecución | READY | US-080 | Costo agregable por assessment y customer | Materializada para R01 con DoD, notas tecnicas, dependencias y complejidad; requiere policy/versionado de precios | Atomizar por owner, incluyendo categoría de costo Groq/Gemini (ver D-04/D-06) |
